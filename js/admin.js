...
function compartirTienda() {
    ...
    if (navigator.clipboard) {
        navigator.clipboard.writeText(url).then(function() {
            NexusDialog.alert("URL de tu tienda copiada al portapapeles:\n\n" + url, "✅ Enlace Compartido");
        }).catch(function() {
